...
function flightControl(){
  ...
  */
  temp.update = function(delta) {
    ...
    if(!pitch)
      copter.angMat._data[0][0] = 0;
    if(!roll)
      copter.angMat._data[2][0] = 0;
